        ...
        <div class="max-w-7xl mx-auto bg-white min-h-screen border-x border-black">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-0">
                <div class="lg:col-span-3 p-6 md:p-16 border-r border-black">
                   <a href="verhalen.html" class="mb-10 border border-black px-6 py-2 text-xs font-bold uppercase hover:bg-black hover:text-white transition-all flex items-center gap-2 inline-flex">
